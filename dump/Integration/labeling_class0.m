...
%
%    Workbook: D:\PS!\CO2_Anomaly_detection\CODE\Anomaly_detect\dataset\100\Simulink_Data2.xlsx
%    Worksheet: Sheet1
%
...
%% Import the data
[~, ~, raw0_0] = xlsread('D:\PS!\CO2_Anomaly_detection\CODE\Anomaly_detect\dataset\100\Simulink_Data2.xlsx','Sheet1','I1:K6');
[~, ~, raw0_1] = xlsread('D:\PS!\CO2_Anomaly_detection\CODE\Anomaly_detect\dataset\100\Simulink_Data2.xlsx','Sheet1','M1:M6');
raw = [raw0_0,raw0_1];
...
% Script for importing data from the following spreadsheet:
%
%    Workbook: D:\PS!\CO2_Anomaly_detection\CODE\Anomaly_detect\dataset\100\Simulink_Data.xlsx
%    Worksheet: Sheet2
%
% To extend the code for use with different selected data or a different
% spreadsheet, generate a function instead of a script.
...
%% Import the data
[~, ~, raw] = xlsread('D:\PS!\CO2_Anomaly_detection\CODE\Anomaly_detect\dataset\100\Simulink_Data.xlsx','Sheet2','A2:I14402');
raw(cellfun(@(x) ~isempty(x) && isnumeric(x) && isnan(x),raw)) = {''};
